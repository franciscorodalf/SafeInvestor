package es.franciscorodalf.saveinvestor.backend.controller;
...
import es.franciscorodalf.saveinvestor.backend.model.UsuarioServiceModel;

public abstract class AbstractController {

    static final String PATH_DB = "src/main/resources/database/usuarios.db";
    ...
    public Properties loadIdioma(String nombreFichero, String idioma) {
        ...
        String path = "src/main/resources/idiomas/" + nombreFichero + "-" + idioma + ".properties";
